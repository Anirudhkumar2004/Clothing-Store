...
<!---Single Product Details--->
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/offer.jpeg" width="100%" id="productImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/offer.jpeg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offer1.jpeg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offer2.jpeg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offer3.jpeg" width="100%" class="small-img">
                    </div>
                </div>          
            </div>
            <div class="col-2">
                <p>Home / Running Shoes</p> 
                <h1>Running Shoes</h1>
                <h4>₹ 1199</h4>
                <select>
